...
exports.SAMPLE_LOG_FILE = exports.SAMPLE_LOG_CONTENT = void 0;
exports.SAMPLE_LOG_CONTENT = `[2024-06-10 14:32:15] [INFO] Player 玩家剑仙 LOGIN player_id:10086123 ip:192.168.1.100 device:iPhone14,3
...
`;
exports.SAMPLE_LOG_FILE = {
    path: 'sample-data://demo-game.log',
    name: '示例游戏日志.log',
    content: exports.SAMPLE_LOG_CONTENT,
    size: exports.SAMPLE_LOG_CONTENT.length,
};
